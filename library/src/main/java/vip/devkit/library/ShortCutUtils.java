 ...
 * 文 件 名: ShortCutUtils
 * 创 建 人: By k
 * 创建日期: 2017/11/1 10:18
 * 邮   箱:  vip@devkit.vip
 * 博   客: www.devkit.vip
 * 修改时间：
 * 修改备注：  需要权限: com.android.launcher.permission.INSTALL_SHORTCUT com.android.launcher.permission.UNINSTALL_SHORTCUT
 */
public class ShortCutUtils {
    ...
    public static boolean hasShortcut(Activity activity,String appName) {
        ...
        Cursor c = cr.query(CONTENT_URI,
                ...
                new String[]{activity.getString(Integer.parseInt(appName)).trim()},
                null);
    ...
    public static void addShortcut(Activity activity,int res,String appName) {
        ...
        shortcut.putExtra(Intent.EXTRA_SHORTCUT_NAME,
                activity.getString(Integer.parseInt(appName)));
